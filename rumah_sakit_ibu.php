...
<main id="main">
  ...
  <div class="container">
    ...
    <div class="section-title">
      <span>Instansi Kesehatan Rumah Sakit Bersalin</span>
      <h2>Instansi Kesehatan Rumah Sakit Bersalin</h2>
    ...
    <div class="row"> 
    <?php $rsum = $conn->query("SELECT * FROM preferensi WHERE jenis='Rumah Sakit Ibu dan Anak' ORDER BY nilai_preferensi DESC"); 
                if($rsum->num_rows>0){
