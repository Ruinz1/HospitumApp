...
if(isset($_POST['register'])){
    ...
    $i = $conn->query("INSERT INTO user (class,username,password,nama) VALUES ('user','$username','$password','$nama')");
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" value="submit" name="register">Create Account</button></div>
                                            </div>
                                        </form>
                                    </div>
